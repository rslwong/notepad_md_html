...
- **Multiple Files Support** - Built-in file explorer sidebar to manage multiple documents concurrently
- **Auto-save** - Automatically saves your work to browser localStorage
- **File Import/Export** - Import `.md` files (via button or drag-and-drop) and export your work as Markdown or Standalone HTML
...
### Export Your Work
- Click the **Export MD** button or press `Ctrl+S` to download the raw Markdown
- Click the **HTML** button to export your rendered notes as a beautifully styled, standalone `.html` webpage
